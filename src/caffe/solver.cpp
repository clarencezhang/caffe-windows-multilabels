...
namespace caffe {
	...
	void Solver<Dtype>::Snapshot() {
		...
		// 1. snapshot the learned net parameters (weights, biases, may including gradient values(diff) )
		...
		// 2. snapshot the solver state (learned network state)
		// 1 -> int32 iter
		// 2 -> string learned_net
		// 3 -> repeated .caffe.BlobProto history 
		//      BlobProto -> bottom/top blob, data_vec & diff_vec 数据序列化 		
		SolverState state;		
