...
extern int convert_image_facial_points(int argc, char** argv) ;

extern int compute_image_mean(int argc, char** argv);
...
int main(int argc, char** argv) 
{
	...
	*/
	...
	// part 0
	// convert images with facial points to LevelDB
	//convert_image_facial_points( argc, argv);
    ...
    // part6 compute image mean values
    //compute_image_mean( argc, argv );
